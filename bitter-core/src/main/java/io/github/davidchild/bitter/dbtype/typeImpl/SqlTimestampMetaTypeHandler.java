...
public class SqlTimestampMetaTypeHandler extends TypeHanderDealBase<Timestamp> {

  @Override
  public void setNonNullParameter(PreparedStatement ps, int i, Timestamp parameter, MetaType jdbcType)
      throws SQLException {
