...
public class LocalDateMetaTypeHandler extends TypeHanderDealBase<LocalDate> {

  @Override
  public void setNonNullParameter(PreparedStatement ps, int i, LocalDate parameter, MetaType jdbcType)
      throws SQLException {
