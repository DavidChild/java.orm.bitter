...
public class ZonedDateTimeMetaTypeHandler extends TypeHanderDealBase<ZonedDateTime> {

  @Override
  public void setNonNullParameter(PreparedStatement ps, int i, ZonedDateTime parameter, MetaType jdbcType) throws SQLException {
