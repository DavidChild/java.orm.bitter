...
public class ByteMetaTypeHandler extends TypeHanderDealBase<Byte> {

  @Override
  public void setNonNullParameter(PreparedStatement ps, int i, Byte parameter, MetaType jdbcType) throws SQLException {
