...
public class InitBitter {
    ...
    public void helloUserBitter() {
        BitterLogUtil.getInstance().info(" \n" +
                ...
                + "                    |/                                             ");
        BitterLogUtil.getInstance().info("version：{}", "2.1.8-RELEASE");
        BitterLogUtil.getInstance().info("Bulbhead by David-Child, October 30, 2024");
        BitterLogUtil.getInstance().info("Figlet release 2.1.8 --  October 30, 2024 ");
