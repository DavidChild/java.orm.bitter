...
public class BigIntegerMetaTypeHandler extends TypeHanderDealBase<BigInteger> {

  @Override
  public void setNonNullParameter(PreparedStatement ps, int i, BigInteger parameter, MetaType jdbcType)
      throws SQLException {
