...
public class CharacterMetaTypeHandler extends TypeHanderDealBase<Character> {

  @Override
  public void setNonNullParameter(PreparedStatement ps, int i, Character parameter, MetaType jdbcType)
      throws SQLException {
