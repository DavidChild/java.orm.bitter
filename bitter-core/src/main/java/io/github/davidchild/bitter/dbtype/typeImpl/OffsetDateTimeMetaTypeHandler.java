...
public class OffsetDateTimeMetaTypeHandler extends TypeHanderDealBase<OffsetDateTime> {

  @Override
  public void setNonNullParameter(PreparedStatement ps, int i, OffsetDateTime parameter, MetaType jdbcType)
      throws SQLException {
