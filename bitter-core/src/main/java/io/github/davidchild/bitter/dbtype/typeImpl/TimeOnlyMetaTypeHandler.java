...
public class TimeOnlyMetaTypeHandler extends TypeHanderDealBase<Date> {

  @Override
  public void setNonNullParameter(PreparedStatement ps, int i, Date parameter, MetaType jdbcType) throws SQLException {
