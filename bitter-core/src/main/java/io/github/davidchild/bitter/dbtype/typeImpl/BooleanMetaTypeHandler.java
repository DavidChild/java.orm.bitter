...
public class BooleanMetaTypeHandler extends TypeHanderDealBase<Boolean> {

  @Override
  public void setNonNullParameter(PreparedStatement ps, int i, Boolean parameter, MetaType jdbcType)
      throws SQLException {
