...
public class MonthMetaTypeHandler extends TypeHanderDealBase<Month> {

  @Override
  public void setNonNullParameter(PreparedStatement ps, int i, Month month, MetaType type) throws SQLException {
