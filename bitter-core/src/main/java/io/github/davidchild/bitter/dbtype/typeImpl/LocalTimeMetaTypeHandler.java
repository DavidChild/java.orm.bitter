...
public class LocalTimeMetaTypeHandler extends TypeHanderDealBase<LocalTime> {

  @Override
  public void setNonNullParameter(PreparedStatement ps, int i, LocalTime parameter, MetaType jdbcType)
      throws SQLException {
