...
public class MetaTypeException extends PersistenceException {
  ...
  public MetaTypeException(String message, Throwable cause) {
    super(message, cause);
  }

  public MetaTypeException(Throwable cause) {
    super(cause);
  }
