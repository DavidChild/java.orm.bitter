...
public class DoubleMetaTypeHandler extends TypeHanderDealBase<Double> {

  @Override
  public void setNonNullParameter(PreparedStatement ps, int i, Double parameter, MetaType jdbcType)
      throws SQLException {
