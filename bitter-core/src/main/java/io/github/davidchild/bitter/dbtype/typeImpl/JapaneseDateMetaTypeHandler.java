...
public class JapaneseDateMetaTypeHandler extends TypeHanderDealBase<JapaneseDate> {

  @Override
  public void setNonNullParameter(PreparedStatement ps, int i, JapaneseDate parameter, MetaType jdbcType)
      throws SQLException {
