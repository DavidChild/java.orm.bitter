...
public class ShortMetaTypeHandler extends TypeHanderDealBase<Short> {

  @Override
  public void setNonNullParameter(PreparedStatement ps, int i, Short parameter, MetaType jdbcType) throws SQLException {
