...
public class FloatMetaTypeHandler extends TypeHanderDealBase<Float> {

  @Override
  public void setNonNullParameter(PreparedStatement ps, int i, Float parameter, MetaType jdbcType) throws SQLException {
