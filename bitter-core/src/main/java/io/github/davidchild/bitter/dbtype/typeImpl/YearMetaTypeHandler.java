...
public class YearMetaTypeHandler extends TypeHanderDealBase<Year> {

  @Override
  public void setNonNullParameter(PreparedStatement ps, int i, Year year, MetaType type) throws SQLException {
