...
public class OffsetTimeMetaTypeHandler extends TypeHanderDealBase<OffsetTime> {

  @Override
  public void setNonNullParameter(PreparedStatement ps, int i, OffsetTime parameter, MetaType jdbcType)
      throws SQLException {
